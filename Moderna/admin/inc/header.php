...
function siteUrl(){
    $basefol = explode('/', $_SERVER['REQUEST_URI']);
    $protocol = explode('/', $_SERVER['SERVER_PROTOCOL']);
    return strtolower($protocol['0'])."://".$_SERVER['SERVER_NAME']."/".$basefol[1];
}
?>
<!DOCTYPE html>
<html lang="en"
    ...
    <head>
        ...
        <!-- Perfect Scrollbar -->
        <link type="text/css"
              href="<?=siteUrl()?>/admin/css/perfect-scrollbar.css"
              rel="stylesheet">

        <!-- App CSS -->
        <link type="text/css"
              href="<?=siteUrl()?>/admin/css/app.css"
              rel="stylesheet">
        

        <!-- Material Design Icons -->
        <link type="text/css"
              href="<?=siteUrl()?>/admin/css/vendor-material-icons.css"
              rel="stylesheet">
       

        <!-- Font Awesome FREE Icons -->
        <link type="text/css"
              href="<?=siteUrl()?>/admin/css/vendor-fontawesome-free.css"
              rel="stylesheet">
                                ...
                                <li class="nav-item dropdown">
                                    <a href="#account_menu"
                                       ...
                                       data-caret="false">
                                        <span class="mr-1 d-flex-inline">
                                            <span class="text-light"><?=$_SESSION['login_user']['name']?></span>
                                        </span>
                                    ...
                                    <div id="account_menu"
                                        ...
                                        <div class="dropdown-item-text dropdown-item-text--lh">
                                            ...
                                            <div class="text-muted">@<?=$_SESSION['login_user']['name']?></div>
                                        </div>
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                           href="../auth/logout.php"><i class="material-icons">exit_to_app</i> Logout</a>
                                    </div>
                                </li>
                            </ul>
